...
export const ActionCard = ({ title, subtitle, buttonText }) => {
  return (
    <div className="relative mb-6">
      ...
      <div className="bg-orange-50/50 rounded-2xl p-6 border-2 border-dashed border-orange-200 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <button className="bg-orange-500 text-white font-bold py-2 px-4 rounded-lg hover:bg-orange-600 transition-colors flex-shrink-0">
          {buttonText}
        </button>
      </div>
    </div>
